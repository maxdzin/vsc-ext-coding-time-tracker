...
class SummaryViewProvider {
    constructor(context, database, timeTracker) {
    ...
    resolveWebviewView(webviewView, context, token) {
        ...
        webviewView.webview.onDidReceiveMessage((message) => __awaiter(this, void 0, void 0, function* () {
            if (message.command === 'refresh') {
                yield this.show(webviewView.webview);
            }
            else if (message.command === 'search') {
                const searchResults = yield this.database.searchEntries(message.startDate, message.endDate, message.project);
    ...
    show(webview) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const projects = yield this.getUniqueProjects();
            const totalTime = {
                today: (0, utils_1.formatTime)(this.timeTracker.getTodayTotal()),
                weekly: (0, utils_1.formatTime)(this.timeTracker.getWeeklyTotal()),
                monthly: (0, utils_1.formatTime)(this.timeTracker.getMonthlyTotal()),
                yearly: (0, utils_1.formatTime)(this.timeTracker.getYearlyTotal()),
                allTime: (0, utils_1.formatTime)(this.timeTracker.getAllTimeTotal())
            };
            if (webview) {
                ...
                this.panel.webview.onDidReceiveMessage((message) => __awaiter(this, void 0, void 0, function* () {
                    var _a, _b;
                    if (message.command === 'refresh') {
                        yield this.show((_a = this.panel) === null || _a === void 0 ? void 0 : _a.webview);
                    }
                    else if (message.command === 'search') {
                        const searchResults = yield this.database.searchEntries(message.startDate, message.endDate, message.project);
                        (_b = this.panel) === null || _b === void 0 ? void 0 : _b.webview.postMessage({ command: 'searchResult', data: searchResults });
                    }
                }), undefined, this.context.subscriptions);
    ...
    getUniqueProjects() {
        return __awaiter(this, void 0, void 0, function* () {
            const entries = yield this.database.getEntries();
            const projectSet = new Set(entries.map(entry => entry.project));
            return Array.from(projectSet).sort();
        });
    }
    getHtmlForWebview(projects) {
